...
DefaultCommandPool::DefaultCommandPool(const Device &device, const RenderPass &renderPass, const SwapChain &swapChain, const GraphicsPipeline &graphicsPipeline, const VkCommandPoolCreateFlags &flags) : CommandPool(device, renderPass, swapChain, graphicsPipeline, flags)
{
    createCommandBuffers();
}

void DefaultCommandPool::recordCommandBuffer(uint32_t index)
{
...
void DefaultCommandPool::createCommandBuffers()
{
